...
define("SERVER_TBKAAS", SERVER_BASE . "initTransaction");
define("SERVER_TBKAAS_VERIFICAR", SERVER_BASE . "estadoOrden");
define("SERVER_TBKAAS_DETALLE", SERVER_BASE . "getOrden");
